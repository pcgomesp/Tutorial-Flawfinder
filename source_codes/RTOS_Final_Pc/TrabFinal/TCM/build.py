...
cSourceList.append(projfile.ProjectFile("tcm.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("tcm/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("tcm/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("tcm/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("tcm/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary tcm_image.hex from tcm_image")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("tcm_image")
  postCommand.mCommand.append("tcm_image.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing tcm_image on avr/arduino/nano\033[0m")
