...
cSourceList.append(projfile.ProjectFile("icm.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("icm/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("icm/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("icm/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("icm/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary icm_image.hex from icm_image")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("icm_image")
  postCommand.mCommand.append("icm_image.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing icm_image on avr/arduino/nano\033[0m")
